                ...
                endpoints: [
                    {
                        ...
                        requiresAuth: false,
                        description: 'Retorna el documento legal vigente. Tipos: terms, privacy, sms_consent, commercial. No requiere autenticación.',
                        pathParams: [{ name: 'type', default: 'commercial' }],
                        defaultBody: '',
                    },
                    {
                        id: 'legal-versions',
                        method: 'GET',
                        path: '/legal/{type}/versions',
                        shortPath: '/legal/{type}/versions',
                        requiresAuth: false,
                        description: 'Lista el historial de versiones publicadas de un documento legal. No requiere autenticación.',
                        pathParams: [{ name: 'type', default: 'commercial' }],
                        defaultBody: '',
                    },
                    {
                        id: 'legal-version',
                        method: 'GET',
                        path: '/legal/{type}/versions/{version}',
                        shortPath: '/legal/{type}/versions/{version}',
                        requiresAuth: false,
                        description: 'Retorna el contenido completo de una versión específica de un documento legal.',
                        pathParams: [
                            { name: 'type', default: 'commercial' },
